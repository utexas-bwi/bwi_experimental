...
1{ inroom(P,R,I+1), -inroom(P,R,I+1) }1 :- searchroom(P,R,I), person(P), room(R), I=0..n-1.
:- searchroom(P,R,I), not facing(D,I) : hasdoor(R,D), not at(R,I), person(P), room(R), I=0..n.
:- searchroom(P,R,I), facing(D,I), open(D,I), hasdoor(R,D), person(P), room(R), door(D), I=0..n.
:- searchroom(P,R,I), inroom(P,R,I), person(P), room(R), I=0..n.
:- searchroom(P,R,I), -inroom(P,R,I), person(P), room(R), I=0..n.
:- searchroom(P,R,I), not canbeinroom(P,R), person(P), room(R), I=0..n.
...
allinmeeting(M,I) :- { not inmeetingornowhere(P,M,I) : ingroup(P,G) }0, at(R,I), meeting(M,G,R), group(G), room(R), I=0..n.
