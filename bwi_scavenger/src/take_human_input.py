...
class DilaogManager:
    ...
    def __init__(self):
        ...
        self.room_list = ['l3_502', 'l3_504', 'l3_508', 'l3_510', 'l3_512', 'l3_516',
                     'l3_436', 'l3_402', 'l3_404', 'l3_416', 'l3_418', 'l3_420',
                     'l3_422', 'l3_430', 'l3_432', 'l3_414a', 'l3_414b']
        
        self.door_list = ['d3_502', 'd3_504', 'd3_508', 'd3_510', 'd3_512', 'd3_516',
    ...
    def task_guiding(self, doorname, client, dialog_handle):
        ...
        log += "guiding: " + roomname
        finished = True

    def task_delivery(self, person, item, client, dialog_handle):
    
        global log
        person_door = self.person_door
        ...
        log += "delivery: " + item + ' ' + upper_person
        finished = True

    def process_request(self, query, client, dialog_handle):
    
        room_list    = self.room_list
        door_list    = self.door_list
        person_door  = self.person_door
    ...
    def gui_thread(self, human_waiting, curr_goal):
    ...
    def platform_thread(self, human_waiting, curr_goal):
...
def handle_dialog(req):
    ...
    p1 = Process(target = dm.gui_thread, args = (human_waiting, curr_goal))
    p2 = Process(target = dm.platform_thread, args = (human_waiting, curr_goal))
    ...
    f = open('/home/bwi/shiqi/log.txt', 'w')
    f.write(log + '\n')
    f.close()

    return DialogResponse('/home/bwi/shiqi/log.txt')
 
def main():

    rospy.init_node('dialog_server')    
    s = rospy.Service('dialog_service', Dialog, handle_dialog)
    rospy.spin()
